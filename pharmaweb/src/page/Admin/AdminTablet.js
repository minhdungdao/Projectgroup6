...
const AdminTablet = () => {
    ...
    const confirmDeleteProduct = async () => {
        ...
        if (!id) return;
        try {
            await httpClient.delete(`/api/Tablet/${id}`);
                            ...
                            <td>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <img
                                        ...
                                        alt="Tablet Press Machine"
                                        style={{ width: '64px', height: '64px', borderRadius: '8px' }}
                                    />
                                </div>
                            </td>
                            <td>{machine.modelNumber}</td>
                            <td>{machine.dies} sets</td>
                            <td>{machine.maxPressure} kN</td>
                            <td>{machine.maxTabletDiameterMM} mm</td>
                            <td>{machine.maxDepthOfFillMM} mm</td>
                            <td>{machine.productionCapacity} tablets/hour</td>
                            <td>{machine.machineSize} mm</td>
                            <td>{machine.netWeightKG} kg</td>
                            <td>{machine.price} $</td>
                            <td>
                                <div className="action-buttons">
                                    <Link
                                        to={`/addtablet/${machine.id}`}
                                        title="Edit"
                                        style={{
